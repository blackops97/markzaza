...
send_api_msg(msg, get_receiver_api(msg), text, true, 'md')
  ...
  if matches[1]:lower() == "banlist" or matches[1]:lower() == "قائمة الحظر" then -- Ban list !
    local chat_id = msg.to.id
...
if matches[1]:lower() == 'kick' or matches[1]:lower() == 'طرد' then
	...
	if matches[1]:lower() == 'banall' or matches[1]:lower() == 'حظر عام' then-- /ban
    if type(msg.reply_id)~="nil" and is_momod(msg) then
      if is_admin1(msg) then
 ...
 if matches[1]:lower() == 'unbanall' or matches[1]:lower() == 'الغاء العام' then-- /ban
    if type(msg.reply_id)~="nil" and is_momod(msg) then
      if is_admin1(msg) then
...
if matches[1]:lower() == 'unban' or matches[1]:lower() == 'الغاء الحظر' then-- /ban
    if type(msg.reply_id)~="nil" and is_momod(msg) then
      if is_admin1(msg) then
  ...
  if matches[1]:lower() == "gbanlist" or matches[1]:lower() == "قائمة العام" then -- Global ban list
    return banall_list()
  end
end
